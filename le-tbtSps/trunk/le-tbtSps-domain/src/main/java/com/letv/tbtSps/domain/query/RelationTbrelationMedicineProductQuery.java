...
/**
 * RelationTbrelationMedicineProductQuery：tbt信息表-相关农产品关联表查询类
 * 
 * @author yuguodong
 * @version 2017-3-25 22:43:03
 * 
 */
public class RelationTbrelationMedicineProductQuery extends Query implements java.io.Serializable  {
