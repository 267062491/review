...
public class RoleController extends BaseController {
    ...
    public String queryByPage(Model model, PageUtil page, RoleQuery query) {
        try {
            List<Role> dataList = roleService.queryRoleListWithPage(query, page);
    ...
    public Wrapper<?> add(Role role) {
        try {
            role.setCreateUser(getLoginUserCnName());
            ...
            LOG.warn("role add fail, exist role.");
            return WrapMapper.wrap(Wrapper.ERROR_CODE, "添加失败，已经存在");
        } catch (Exception e) {
            LOG.error("role add has error.", e);
            return WrapMapper.wrap(Wrapper.ERROR_CODE, "添加失败！");
        }
    }
    ...
    public Wrapper<?> update(Model model, Role role) {
        try {
            ...
            LOG.error("role update has error.", e);
    ...
    public Wrapper<?> delete(Role role) {
        try {
            ...
            LOG.error("role delete has error.", e);
            return WrapMapper.error();
        }
    }
