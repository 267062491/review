...
//公共静态变量
TreeGrid.FOLDER_OPEN_ICON = "#springUrl('')/static/images/folderOpen.gif";
TreeGrid.FOLDER_CLOSE_ICON = "#springUrl('')/static/images/folderClose.gif";
TreeGrid.DEFAULT_LEAF_ICON = "#springUrl('')/static/images/defaultLeaf.gif";
TreeGrid.COUNT = 1;
