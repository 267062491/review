...
function refreshCheckCode() {
    var append = basePath + '/checkCode/createImage?clearCache=' + new Date().getTime() + 'a' + Math.random();
    $('#imageCode').attr('src', append);    
}
function toUpdateLanguage(lang){
	window.location.href=(basePath + '/index?locale='+lang);
}
